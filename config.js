module.exports = {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1088032923443277824", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
  ...
  MUSIC: {
    ...
    LAVALINK_NODES: [
      {
        host: "halucy.lrmn.repl.co",
        port: 443,
        password: "@Bliblidotcom7",
        id:"Local Node",
        secure: true
      }
    ]    
