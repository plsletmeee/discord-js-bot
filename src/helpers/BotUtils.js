...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/lrmn7/discord-js-bot/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/lrmn7/discord-js-bot/releases/latest");
      }
    }
  }
